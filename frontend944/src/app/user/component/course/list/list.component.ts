...
export class CourseListingComponent implements OnInit {
  ...
  remove(item: any, index: number) {
    if (window.confirm(this.translate.instant('Are you sure want to delete this task?'))) {
      this.courseService
        .delete(item._id)
        .then(() => {
          this.toasty.success(this.translate.instant(this.translate.instant('Task has been deleted!')));
